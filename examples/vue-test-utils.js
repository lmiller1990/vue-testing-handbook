...
function vmCtorMatchesName (vm, name) {
  console.log(name, vm.$vnode.componentOptions.Ctor.options.name)
  //console.log(`Finding by name: ${name}`)
  //console.log(`Candidates: ${vm.$vnode.componentOptions.Ctor.options.name}`, vm.$options.name)
  return !!(
    (vm.$vnode &&
...
function mount (
  ...
  console.log("mount", component.name)
